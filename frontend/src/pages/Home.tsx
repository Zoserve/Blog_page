              ...
              {featuredBlog && (
                ...
                >
                  <Link to={`/blog/${featuredBlog.slug}`} className="block aspect-[21/9] w-full bg-slate-100 relative overflow-hidden">
                    <img
                      src={featuredBlog.heroImage ? `http://localhost:9090${featuredBlog.heroImage}` : 'https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=800'}
                ...
                {latestBlogs.map((blog, idx) => (
                  ...
                  >
                    <Link to={`/blog/${blog.slug}`} className="aspect-[16/10] w-full bg-slate-100 relative overflow-hidden block">
                      <img
                        src={blog.heroImage ? `http://localhost:9090${blog.heroImage}` : 'https://images.unsplash.com/photo-1557683316-973673baf926?q=80&w=400'}
                        alt={blog.title}
                        className="w-full h-full object-cover group-hover:scale-102 transition-transform duration-500"
                        onError={(e) => {
